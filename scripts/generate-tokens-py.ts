#!/usr/bin/env npx tsx
// =============================================================================
// Gerador do espelho Python (tokens.py) a partir de src/design/tokens.ts
// =============================================================================
// Uso: npx tsx scripts/generate-tokens-py.ts
//       ou: just design:gerar
//
// Gera tokens.py com os mesmos valores do TypeScript.
// Apos gerar, git diff --exit-code deve passar (arquivo commitado = gerado).
// =============================================================================
...
// ---------------------------------------------------------------------------
// Valores espelhados do TypeScript (mantidos manualmente em sincronia)
// ---------------------------------------------------------------------------
// A geracao e por template, nao por parse, porque o TypeScript tem tipos
// que nao sobrevivem a runtime (const assertions, tipos literais).
// O teste design:testar valida que os valores batem.

function generateTokensPy(): string {
  return `# =============================================================================
...
const outputPath = resolve(rootDir, "tokens.py");
writeFileSync(outputPath, generateTokensPy(), "utf-8");
